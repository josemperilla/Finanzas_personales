...
const toastStyle: React.CSSProperties = { position: 'fixed', bottom: 'calc(110px + env(safe-area-inset-bottom))', left: '50%', transform: 'translateX(-50%)', zIndex: 9997, background: 'var(--ink)', color: '#fff', borderRadius: 999, padding: '10px 18px', fontSize: 13, fontWeight: 600, fontFamily: 'var(--font-body)', maxWidth: '90%', textAlign: 'center', boxShadow: 'var(--shadow-float)' };
