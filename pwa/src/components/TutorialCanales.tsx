...
const CARDS: Card[] = [
  ...
  },
  {
    ...
    descripcion: 'Captura transacciones desde las notificaciones de tu app bancaria en Android.',
    pasos: [
...
export function TutorialCanales({ userId, onClose }: Props) {
